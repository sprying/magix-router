...
var MagixRouter = function MagixRouter (options) {
...
MagixRouter.prototype.match = function match (
  raw,
  current,
  redirectedFrom
) {
...
MagixRouter.prototype.onReady = function onReady (cb, errorCb) {
  this.history.onReady(cb, errorCb);
};

MagixRouter.prototype.onError = function onError (errorCb) {
  this.history.onError(errorCb);
};

MagixRouter.prototype.push = function push (location, onComplete, onAbort) {
  this.history.push(location, onComplete, onAbort);
};

MagixRouter.prototype.replace = function replace (location, onComplete, onAbort) {
  this.history.replace(location, onComplete, onAbort);
};

MagixRouter.prototype.go = function go (n) {
  this.history.go(n);
};

MagixRouter.prototype.back = function back () {
  this.go(-1);
};

MagixRouter.prototype.forward = function forward () {
  this.go(1);
};

MagixRouter.prototype.getMatchedComponents = function getMatchedComponents (to) {
  var route = to
    ? to.matched
      ? to
...
MagixRouter.prototype.resolve = function resolve (
  to,
  current,
  append
) {
...
MagixRouter.prototype.addRoutes = function addRoutes (routes) {
...
Object.defineProperties( MagixRouter.prototype, prototypeAccessors );
